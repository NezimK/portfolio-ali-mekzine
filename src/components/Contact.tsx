...
export const Contact = () => {
  ...
  return <section id="contact" className="section-padding bg-background-secondary">
              ...
              <div className="card-premium">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  <div>
                    ...
                    <input type="email" id="email" name="email" required value={formData.email} onChange={handleChange} className="w-full px-4 py-3 bg-input border border-border rounded-xl text-foreground placeholder-foreground-muted focus:border-accent focus:ring-1 focus:ring-accent focus:outline-none transition-colors" placeholder="votre@email.com" />
                  </div>
                  ...
                  <div>
                    ...
                    <textarea id="message" name="message" required rows={6} value={formData.message} onChange={handleChange} className="w-full px-4 py-3 bg-input border border-border rounded-xl text-foreground placeholder-foreground-muted focus:border-accent focus:ring-1 focus:ring-accent focus:outline-none transition-colors resize-none" placeholder="Décrivez votre projet ou vos besoins..." />
                  </div>
                  
                  <button type="submit" className={cn('btn-primary w-full group', 'flex items-center justify-center space-x-2')}>
            ...
            <AnimatedSection delay={400}>
              <div className="space-y-8">
                ...
                <div className="glass rounded-3xl p-8">
                  ...
                  <a href="mailto:[Ton Email]" className="flex items-center space-x-4 text-foreground-muted hover:text-accent transition-colors group">
                    <div className="w-12 h-12 rounded-xl bg-accent/10 flex items-center justify-center group-hover:bg-accent/20 transition-colors">
                      <Mail className="w-6 h-6 text-accent" />
                    </div>
                    <div>
                      <p className="font-medium text-foreground">alimekzine7@gmail.com
                    </p>
